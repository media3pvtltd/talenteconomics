    ...
    describe "Admin" do
      describe "galleries" do
        ...
        describe "galleries list" do
          before do
            FactoryGirl.create(:gallery, :caption => "UniqueTitleOne")
            FactoryGirl.create(:gallery, :caption => "UniqueTitleTwo")
          end
        ...
        describe "create" do
          ...
          context "duplicate" do
            before { FactoryGirl.create(:gallery, :caption => "UniqueTitle") }
        ...
        describe "edit" do
          before { FactoryGirl.create(:gallery, :caption => "A caption") }
        ...
        describe "destroy" do
          before { FactoryGirl.create(:gallery, :caption => "UniqueTitleOne") }
