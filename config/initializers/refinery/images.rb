...
Refinery::Images.configure do |config|
  ...
  # config.pages_per_admin_index = 12
  ...
  # config.dragonfly_secret = "7609a44141b446bbd0909dc20ba62fc03a1b154af7c3ea28"
  # If you decide to trust file extensions replace :ext below with :format
   config.dragonfly_url_format = "/system/images/:job/:basename.:format"
   # config.dragonfly_url_host = "http://127.0.0.1:3000/cms"
  # config.datastore_root_path = "/home/sid/Downloads/talentecnms/public/system/refinery/images"
